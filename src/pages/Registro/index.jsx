        ...
        <form>
          ...
          <label className="label-campo">
            ...
            <input
              type="text"
              className="input-formulario"
              value={apellidos_paternos}
              onChange={(e) => setApellidosPaternos(e.target.value)}
            />
          </label>
          <label className="label-campo">
            Apellidos Maternos
            <input
              type="text"
              className="input-formulario"
              value={apellidos_maternos}
              onChange={(e) => setApellidosMaternos(e.target.value)}
            />
          </label>
          <label className="label-campo">
            Edad
          ...
          <label className="label-campo">
            ...
            <div className="progress">
              <div
                className={`progress-bar ${claseBarra}`}
                role="progressbar"
                style={{ width: `${seguridad}%` }}
              ></div>
            </div>
          </label>
          <label className="label-campo">
